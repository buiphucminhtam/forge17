...
> **This file is read by Antigravity on every new chat.** It tells the AI assistant how to use Forgewright's 53 specialized skills.
...
All 53 skills are in the `skills/` directory:
