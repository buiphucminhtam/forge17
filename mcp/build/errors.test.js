...
import { ForgewrightError, StateError, PipelineError, ToolError, SkillError, ErrorCode, isForgewrightError, getErrorMessage, } from './errors.js';
describe('ErrorCode', () => {
...
describe('isForgewrightError', () => {
    it('should return true for ForgewrightError instances', () => {
        ...
        expect(isForgewrightError(new PipelineError(ErrorCode.PIPELINE_INVALID_MODE, 'test'))).toBe(true);
